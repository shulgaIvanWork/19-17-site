...
export const photoBlur: Record<string, string> = {
  ...
  '/works/flow/01-task.webp': 'data:image/webp;base64,UklGRiYAAABXRUJQVlA4IBoAAAAwAQCdASoMAAMAA4BaJaQAA3AA/vTrUAAAAA==',
  '/works/flow/02-associations.webp': 'data:image/webp;base64,UklGRioAAABXRUJQVlA4IB4AAAAwAQCdASoMAAgAA4BaJaQAA3AA/vThJA7W46GAAAA=',
  '/works/flow/03-references.webp': 'data:image/webp;base64,UklGRpAAAABXRUJQVlA4IIQAAAAQBACdASoMABMAPu1iqU2ppaOiMAgBMB2JQBYdsW+cJFo3uVQspZFTAAD+sjIPC/Z7PyPbm3NX4OW0d+WlOXB9E7kaC4lyumeiyulss0HmR5XplF3j1k1a4cw17kmBE1qtMcbPnwr/W8aEB8i9/vC0xBgshk5AktbFqLIB1NybztiIAAA=',
  '/works/flow/04-photos.webp': 'data:image/webp;base64,UklGRngAAABXRUJQVlA4IGwAAAAwAgCdASoMAA4AA4BaJQBOgMV4325PAwUMkAD+1im6izqqiSdWSaWvMAy/hwjvOT8KeOfr5+ftHipJhjafqynrKapB0bnIGNfPs46gRpiSAzhiL350jrJ9Fj+eIn2MBJrkt0E2ADug7aBGEAA=',
  '/works/flow/05-palette.webp': 'data:image/webp;base64,UklGRjwAAABXRUJQVlA4IDAAAADQAQCdASoMAAQAA4BaJYwCdH8AFcfa0AD+7dmfshL6oGPeaNmBtJ6ou5ywa8FAAAA=',
  '/works/flow/06-fonts.webp': 'data:image/webp;base64,UklGRioAAABXRUJQVlA4IB4AAAAwAQCdASoMAAsAA4BaJaQAA3AA/vTp7U0uR+nAAAA=',
  '/works/flow/07-concepts.webp': 'data:image/webp;base64,UklGRl4AAABXRUJQVlA4IFIAAAAQAgCdASoMAAkAA4BaJQAB8YIZSiy/PZgAAP73PT546vmhI/7l2t35IjSAGCI3Li9UK1tONcCjamaT9zkuYY+hBYfvGvRCM2pkl5W34iurlAAA',
