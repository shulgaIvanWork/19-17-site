 ...
 *  панель под первой вкладкой шапки, мобильное меню и подвал.
 *
...
/** Название первой вкладки шапки. Ведет она на главную, но названа «Услуги»:
 *  панель со всеми услугами раскрывается именно под ней, а слово «Главная» не
 *  подсказывало, что там список (правка заказчика 2026-09-24). */
export const homeLabel = 'Услуги';

export const mainNav: NavItem[] = [{ href: '/', label: homeLabel }, ...companyLinks];
