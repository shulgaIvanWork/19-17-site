...
function AiStack({ uid }: { uid: string }) {
  return (
    <g>
      <Piece kind="sortL" origin="94px 164px">
        <Pane x={30} y={54} w={128} h={220} r={16} kind="glassLift" />
        <T x="42" y="76" k="typeSub" write="A">
          Документы
        </T>
        <RowHit x={42} y={92} w={104} h={36} r={8}>
          <T x="42" y="102" write="B">
            Регламент отпуска
          </T>
          <T x="42" y="120" k="typeSub" write="B">
            PDF · 14 страниц
          </T>
        </RowHit>
        <RowHit x={42} y={140} w={104} h={68} r={8}>
          <T x="42" y="148" k="typeSub" write="C">
            4.2. Заявление подается
          </T>
          <T x="42" y="166" k="typeSub" write="C">
            не позднее чем за 14
          </T>
          <T x="42" y="184" k="typeSub" write="C">
            календарных дней до
          </T>
          <T x="42" y="202" k="typeSub" write="C">
            начала отпуска.
          </T>
        </RowHit>
        <RowHit x={42} y={216} w={104} h={22} r={8} rest>
          <T x="50" y="231" k="typeSub" write="D">
            источник · п. 4.2
          </T>
        </RowHit>
        <RowHit x={42} y={244} w={104} h={22} r={8}>
          <T x="42" y="258" k="typeSub" write="D">
            Правила командировок
          </T>
        </RowHit>
      </Piece>
      <Piece kind="sortM" origin="230px 196px">
        <g className={styles.rowHit}>
          <circle className={styles.glassLift} cx="230" cy="196" r="48" />
          <circle className={styles.wash} cx="230" cy="196" r="48" />
          <T x="230" y="192" k="typeLead" anchor="middle" write="B">
            Qwen
          </T>
          <T x="230" y="210" k="typeSub" anchor="middle" write="C">
            8B · локально
          </T>
        </g>
      </Piece>
      <Piece kind="lock">
        <path className={styles.line} d="M 158 126 H 184" />
        <path className={styles.line} d="M 278 168 H 318" />
        <path className={styles.line} d="M 304 154 L 318 168 L 304 182" />
      </Piece>
      <Piece kind="sortR" origin="397px 200px">
        ...
        <g className={styles.rowHit}>
          <rect className={styles.glassSoft} x="334" y="156" width="126" height="108" rx="14" />
          <rect className={`${styles.glassInk} ${styles.rest}`} x="334" y="156" width="126" height="108" rx="14" />
          <rect className={styles.wash} x="334" y="156" width="126" height="108" rx="14" />
          ...
          <T x="346" y="246" k="typeSub" write="D">
            Источник: п. 4.2
          </T>
        </g>
